/**
 * Jet Village 2 — composition root (0.1.2 warrior sheet + city ground tiles).
...
async function loadWarrior(): Promise<void> {
  const atlas = await loadJson<SpriteAtlasData>(publicAssetUrl('assets/sprites/warrior-sword.json'));
